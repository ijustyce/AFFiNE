        ...
        when (child) {
            ...
            is Heading -> {
                ...
                val headingStyle = when (child.level) {
                    1 -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 28.sp)
                    2 -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 22.sp)
                    3 -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 20.sp)
                    4 -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 17.sp)
                    5 -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 17.sp)
                    else -> SpanStyle(fontWeight = FontWeight.SemiBold, fontSize = 16.sp)
                }
